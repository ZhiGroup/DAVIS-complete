...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_df', type=str, default=f'{DATA_DIR}/davis_complete.tsv', help='data of protein and ligand')
    ...
    ligand = list(pd.read_csv(f'{DATA_DIR}/davis_inhibitor_binding_mode.csv')['Compound'])
