...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_df', type=str, default=f'{DATA_DIR}/davis_complete_with_smiles.tsv', help='data of protein and ligand')
    parser.add_argument('--complex_path', type=str, default=f'{DATA_DIR}/alphafold_structure_kinase_domain', help='the path of the complexes')
    parser.add_argument('--mmseqs_seq_clus_df', type=str, default=f'{DATA_DIR}/davis_complete_id50_cluster.tsv', help='the path of mmseqs seq clus')
