...
if __name__ == '__main__':
    ...
    random_test_wt = GraphDataset(data_root, data_df, split_method='random', split='test_wt', graph_type='Graph_GIGN', dis_threshold=5, mmseqs_seq_clus_df=mmseqs_seq_clus_df, create=True)
    random_test_mutation = GraphDataset(data_root, data_df, split_method='random', split='test_mutation', graph_type='Graph_GIGN', dis_threshold=5, mmseqs_seq_clus_df=mmseqs_seq_clus_df, create=True)
