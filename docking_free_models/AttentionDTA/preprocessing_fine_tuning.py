...
class Dataset(Dataset):
    ...
    """
    def __init__(self, df, split_method, split, protein, mutation=None, seqlen=1200, smilen=100, drug=None, drug_type=None, drug_1_type=None, drug_2_type=None, seed=None, nontruncated_affinity=True, transform=None, pre_transform=None, pre_filter=None):
        """
        ...
        self.protein_vocab = sorted(list(self.protein_vocab))
        self.ligand_vocab = sorted(list(self.ligand_vocab))
...
def collate_fn(batch):
    ...
    return ligands, proteins, affinities
